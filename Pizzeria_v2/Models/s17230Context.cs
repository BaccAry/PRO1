...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdZamowieniePizza)
                    .HasName("ZamowieniePizza_pk");

                entity.Property(e => e.IdZamowieniePizza).ValueGeneratedNever();

                entity.HasOne(d => d.IdPizzaNavigation)
                    .WithMany(p => p.ZamowieniePizza)
                    .HasForeignKey(d => d.IdPizza)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ZamowieniePizza_Pizza");

                entity.HasOne(d => d.IdZamowienieNavigation)
                    .WithMany(p => p.ZamowieniePizza)
                    .HasForeignKey(d => d.IdZamowienie)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ZamowieniePizza_Zamowienie");
            });
        }
    }
}
